...
Have an implementation plan?
  No  -> Write the plan first (qwickapps-sdlc:writing-plans)
...
Then use the qwickapps-sdlc:finishing-branch skill to close out the development branch.
...
Use qwickapps-sdlc:finishing-branch to close out.
```
...
- **qwickapps-sdlc:writing-plans** -- Creates the plan this skill executes. Run this first.
- **qwickapps-sdlc:creating-worktree** -- Set up an isolated workspace before starting implementation.
- **qwickapps-sdlc:requesting-review** -- Code review template for reviewer subagents.
- **qwickapps-sdlc:finishing-branch** -- Complete development after all tasks pass review.
- **qwickapps-sdlc:writing-tests** -- Subagents follow test-driven development for each task.
- **qwickapps-sdlc:parallelizing-work** -- Use instead when independent failures need concurrent investigation rather than sequential implementation.

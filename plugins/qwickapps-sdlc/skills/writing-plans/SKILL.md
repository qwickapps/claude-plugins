...
> **For Claude:** Use qwickapps-sdlc:executing-plans to implement this plan task-by-task.
...
Open a new Claude session in the worktree. Use qwickapps-sdlc:executing-plans to run the plan with batch checkpoints.
